    ...
    def __init__(self, train, validation, test):
        ...
        if self.train == True:
            ...
            self.transform = transforms.Compose([
                ...
                transforms.RandomResizedCrop(448),  # 随机长宽比裁剪为224*224
...
class ImageDatasettest(Dataset):
    ...
    def __init__(self, train, validation, test):
        ...
        # self.imgs_path0 = list(sorted(os.listdir('./size_512/0')))
        # self.imgs_path1 = list(sorted(os.listdir('./size_512/1')))
        # self.imgs_path2 = list(sorted(os.listdir('./size_512/2')))
        # self.imgs_path3 = list(sorted(os.listdir('./size_512/3')))
        self.imgs_path = list(sorted(os.listdir('./size_512/all-test')))

        # with torch.no_grad():
        #     for img_name0, img_name1, img_name2, img_name3 in zip( self.imgs_path0,  self.imgs_path1,  self.imgs_path2,  self.imgs_path3):
        #         img_path0 = os.path.join('./size_512/0', img_name0)
        #         img_path1 = os.path.join('./size_512/1', img_name1)
        #         img_path2 = os.path.join('./size_512/2', img_name2)
        #         img_path3 = os.path.join('./size_512/3', img_name3)
        ...
        # self.left_image_names0 = self.imgs_path0
        # self.left_image_names1 = self.imgs_path1
        # self.left_image_names2 = self.imgs_path2
        # self.left_image_names3 = self.imgs_path3
        self.left_image_names = self.imgs_path
        # self.label0='0'
        # self.label1='1'
        # self.label2='2'
        ...
        # self.right_image_names = self.csv[:]['Right-Fundus']
        self.images = []
        # self.train_len0 = int(0.8*len(self.left_image_names0))
        # self.train_len1 = int(0.8 * len(self.left_image_names1))
        # self.train_len2 = int(0.8 * len(self.left_image_names2))
        # self.train_len3 = int(0.8 * len(self.left_image_names3))
        self.train_len = int(len(self.left_image_names))
        # self.valid_len = int(0.015*len(self.csv))
        # self.test_len0 = len(self.left_image_names0) - self.train_len0
        # self.test_len1 = len(self.left_image_names1) - self.train_len1
        # self.test_len2 = len(self.left_image_names2) - self.train_len2
        # self.test_len3 = len(self.left_image_names3) - self.train_len3
        ...
        if self.train == True:
            ...
            # self.Limage_names0 = list(self.left_image_names0[-self.train_len0:])
            # self.Limage_names1 = list(self.left_image_names1[-self.train_len1:])
            # self.Limage_names2 = list(self.left_image_names2[-self.train_len2:])
            # self.Limage_names3 = list(self.left_image_names3[-self.train_len3:])
            self.Limage_names = list(self.left_image_names[:self.train_len])
